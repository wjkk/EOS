<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:51:"themes/admin_simpleboot3/admin/challenge/index.html";i:1537497627;s:77:"/mnt/kh_xcx/yitaibi_ml3k9o/public/themes/admin_simpleboot3/public/header.html";i:1526536240;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8">
...
<div class="wrap js-check-wrap">
    ...
    <ul class="nav nav-tabs">
        ...
        <li class="active"><a href="javascript:;">挑战列表</a></li>
        ...
        <!--start foreach-->
            ...
            <?php if(is_array($order) || $order instanceof \think\Collection || $order instanceof \think\Paginator): if( count($order)==0 ) : echo "" ;else: foreach($order as $key=>$vo): ?>
                ...
                <tr class="foreachTr" >
                    ...
                    <td><?php echo (isset($vo['name']) && ($vo['name'] !== '')?$vo['name']:'暂无设置'); ?></td>
                    <td><img src="<?php echo $vo['head_img']; ?>" width="50" height="50"></td>
                    <td><?php echo $vo['a_name']; ?></td>
                    <td><?php echo $vo['status']; ?></td>
                    <td><?php echo (isset($vo['eth']) && ($vo['eth'] !== '')?$vo['eth']:0.00); ?></td>

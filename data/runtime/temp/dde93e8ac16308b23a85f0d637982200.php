<?php if (!defined('THINK_PATH')) exit(); /*a:4:{s:61:"themes/admin_simpleboot3/admin/theme/file_widget_setting.html";i:1526536240;s:85:"/mnt/kh_xcx/yitaibi_ml3k9o/public/themes/admin_simpleboot3/admin/theme/functions.html";i:1526536240;s:77:"/mnt/kh_xcx/yitaibi_ml3k9o/public/themes/admin_simpleboot3/public/header.html";i:1526536240;s:83:"/mnt/kh_xcx/yitaibi_ml3k9o/public/themes/admin_simpleboot3/admin/theme/scripts.html";i:1526536240;}*/ ?>
<?php 
                        ...
                        <div>
                            <a href="javascript:uploadOneImage('图片上传','#js-<?php echo $widget; ?><?php echo $varName; ?>-input');">
                                <?php if(empty($vars[$varName]['value'])): ?>
                                    <img src="/yitaibi_ml3k9o/public/themes/admin_simpleboot3/public/assets/images/default-thumbnail.png"
                            ...
                            <?php if(!empty($vars[$varName]['value'])): ?>
                                <br>
                                <button id="js-<?php echo $widget; ?><?php echo $varName; ?>-button-remove" defaultImage="/yitaibi_ml3k9o/public/themes/admin_simpleboot3/public/assets/images/default-thumbnail.png" class="removeImage btn btn-sm" type="button" onclick="removeImage('<?php echo $widget; ?><?php echo $varName; ?>')">取消图片</button>
                            <?php endif; ?>
                        </div>
                        <?php if(isset($var['tip'])): ?>
                            <p class="help-block"><?php echo $var['tip']; ?></p>

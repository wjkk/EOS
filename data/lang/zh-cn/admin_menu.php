<?php
return array (
  'ADMIN_ACCUSATIONLIST_INDEX' => '举报列表',
  'ADMIN_ACTIVITY_INDEX' => '活动列表',
  'ADMIN_ADMIN_FORWARD' => '提现列表',
  'ADMIN_ADMIN_INDEX' => '订单列表',
  'ADMIN_ADMIN_RECHARGE' => '充值列表',
  'ADMIN_CHALLENGE_INDEX' => '挑战列表',
  ...
  'ADMIN_QUESTIONS_DEFEAULT' => '题库管理',
  'ADMIN_QUESTIONS_IMPORT' => '题库导入',
  'ADMIN_QUESTIONS_INDEX' => '题库列表',
  'ADMIN_RBAC_AUTHORIZE' => '设置角色权限',
  'ADMIN_RBAC_AUTHORIZEPOST' => '角色授权提交',
  'ADMIN_RBAC_INDEX' => '权限设置',
  ...
  'ADMIN_REGISTER_INDEX' => '用户列表',
  'ADMIN_REMARK_INDEX' => '邀请码',

...
class HomeBaseController extends BaseController
{
    ...
    public function randcookie()
    {

       $phone = Session::get('phone');
       $randcookie = Cookie::get('randcookie');


  $sql = Db::name('register')->where('phone',$phone)->find();
       $domain = url('register/login');

        // dump($sql['randcookie'].'---'.$randcookie);die;
        if($sql['randcookie']!=$randcookie || empty($phone)){
            // $this->redirect(cmf_url("register/login"));
